...
const ReducePDFSize = () => {
  ...
  const handleCompress = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${process.env.REACT_APP_BACKEND_URL}/api/compress-pdf`,
        {
          method: "POST",
          body: formData,
        }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 p-8">
      <div className="max-w-4xl mx-auto space-y-8 rounded-lg bg-white/10 backdrop-blur p-6">
        <Toaster />
              ...
              <div className="grid md:grid-cols-3 gap-4 text-center">
                ...
                <div className="bg-white/5 rounded-lg p-4">
                  ...
                  <p className="text-green-300 text-xl font-bold">
                    {formatFileSize(Math.floor(originalSize * 0.1))}
                  </p>
                </div>
                <div className="bg-white/5 rounded-lg p-4">
              ...
              <div className="space-y-3">
                ...
                <p className="text-white/80 text-sm">
                  {isProcessing
                    ...
                    : `Compression completed! Reduced size by ${compressionRatio.toFixed(
                        1
                      )}%`}
                </p>
              </div>
